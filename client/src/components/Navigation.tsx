        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden lg:block">
            <div className="ml-10 flex items-baseline space-x-8">
              ...
              {/* Resources Dropdown */}
              <DropdownMenu>
                <DropdownMenuTrigger className="flex items-center text-blue-900 hover:text-blue-700 px-3 py-2 text-sm font-medium transition-colors" data-testid="nav-resources-dropdown">
      ...
      {isMenuOpen && (
        <div className="lg:hidden bg-white/95 backdrop-blur-sm border-t border-gray-200" data-testid="mobile-menu">
          <div className="px-4 py-3 space-y-3 max-h-96 overflow-y-auto">
            ...
            >
              <CollapsibleTrigger className="flex justify-between items-center w-full text-blue-900 hover:text-blue-700 px-3 py-3 min-h-[44px] text-base font-medium transition-colors touch-target" data-testid="mobile-nav-services">
                Services
            ...
            >
              <CollapsibleTrigger className="flex justify-between items-center w-full text-blue-900 hover:text-blue-700 px-3 py-3 min-h-[44px] text-base font-medium transition-colors touch-target" data-testid="mobile-nav-resources">
                Resources
